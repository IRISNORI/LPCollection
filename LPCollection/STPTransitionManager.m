...
- (instancetype)initWithCollectionViewController:(UICollectionViewController *)collectionViewController
{
    ...
    if (self != nil)
    {
        ...
        UIPinchGestureRecognizer *pinchGesture =
        [[UIPinchGestureRecognizer alloc] initWithTarget:self action:@selector(handlePinch:)];
        [collectionViewController.collectionView addGestureRecognizer:pinchGesture];
...
- (void)startInteractiveTransition:(id <UIViewControllerContextTransitioning>)transitionContext
{
    ...
    //NSLog(@"se %@", self.selectedIndexPath);
    //NSLog(@"ss %@", [fromCollectionViewController.collectionView cellForItemAtIndexPath:self.selectedIndexPath]);
